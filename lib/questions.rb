...
def separate_array_into_even_and_odd_numbers(array)
  result = []
  result << evens = array.select { |x| x.even? }
  result << odds = array.select { |x| x.odd? }
end
...
def number_of_elements_that_are_palindromes(array)
  array.select { |word| word.reverse == word }.count
end
...
# The Hash.[] method converts an even number of parameters to a Hash.
...
def is_a_2014_bank_holiday?(date)
  bank_holidays = ["2014/05/26", "2014/08/25", "2014/12/25", "2014/12/26"]
